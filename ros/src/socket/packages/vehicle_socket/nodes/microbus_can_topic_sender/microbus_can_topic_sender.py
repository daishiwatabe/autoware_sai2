...
class Microbus_Can_Sender:
	...
	def __init__(self):
		...
		self.pub_input_steer_value = rospy.Publisher('/microbus/input_steer_value', Float64, queue_size=1)
		self.pub_input_drive_value = rospy.Publisher('/microbus/input_drive_value', Float64, queue_size=1)
